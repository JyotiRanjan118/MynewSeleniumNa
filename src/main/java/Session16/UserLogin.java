...
public class UserLogin {
	...
	public static void main(String[] args) {
		...
		doLogin(driver, userMap, "patient");
		*/
	...
	public static Map<String, String> getUsermap() {
		...
		userMap.put("admin", "admin@123_admin");
		userMap.put("patient", "jrnbabu118@gmail.com_jrnBABU@118");
		userMap.put("doctor", "peter195@gmail.com_test12345");
